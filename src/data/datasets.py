...
# country-level data
generations_xlsx = XlsxFile('generations.xlsx')
production_age = XlsxFile('production_age.xlsx')
powiats_xlsx = XlsxFile('powiats.xlsx')
subregions_capitals_xlsx = XlsxFile('subregions_capitals.xlsx')
powiats_subregions_mapping_xlsx = XlsxFile('powiats_subregion_capital_mapping.xlsx')
...
output_households_xlsx = XlsxFile('households.xlsx')
output_population_xlsx = XlsxFile('population.xlsx')
